...
function App() {
  ...
  return (
    ...
    <hr />
        ...
        {/* 5. */}
        <p>결과 : { (x2) > 10 ? "True" : "False"} </p> {/* 상함조건 연산자 */}
        <hr />
        ...
        {/* 9 */}
        <p><button onClick={evt1}>클릭하세용!!</button></p>
        <hr />

        {/* 10 */}
        <p><button onClick={() => evt2("evt2 클릭했어요")}>클릭하세용!!</button></p>
        <hr />

        {/* 11 */}
        
        <p><button onClick={(event) => evt3("evt3 클릭했어요",event)}>클릭하세용!!</button></p>
        <hr />
        {/* 12 */}
        {/* => 이거펑션이라는뜻 ㅋ */}
