$(document).ready(function(){
    ...
    //
    $("#emall_1").focus().css("color","#999999");
    $("#email_list").change(function(){
        $("#email4 span input").val($(this).val()).css("color","red");
        // if($(this).val() == ""){
        ...
        $("#select9_1").change(function(){
            ...
            $("#select9_2 option").hide();
            $("#select9_2 .s"+n9).show();
            $("#select9_2").val("선택하세요"); //다른 지역누를떄 셀럭터 2의 벨류값이 선택하세요로 바뀜

        });

        //
        //$(셀럭터).submit() 폼이벤트(양식이 전송 될 때 발생)
        ...
        $("#chk12").val("안녕").css({"color":"#999999"});
        $("input[name='chk12']").change(function(){
            $("#chk12").val($(this).val()+"ㅋㅋ");
        }); 
